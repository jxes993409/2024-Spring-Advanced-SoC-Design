...
#directive set /EdgeDetect_IP::EdgeDetect_MagAng/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
...
go assembly
directive set /EdgeDetect_IP::EdgeDetect_Top/dat_x:cns -FIFO_DEPTH 0
directive set /EdgeDetect_IP::EdgeDetect_Top/dat_y:cns -FIFO_DEPTH 0
